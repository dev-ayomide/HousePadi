...
export const metadata = {
  title: 'Terms & Conditions | HousePadi',
  description: 'Terms and conditions for accessing and using the HousePadi luxury real estate visualization platform.',
}

export default async function TermsPage() {
  const result = await getSiteSettings()
  const settings = result.success ? result.data : {}
  const rawContent = settings.terms_content || '# Terms & Conditions\n\nDefault terms will be updated shortly.'
